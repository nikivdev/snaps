...
export default {
  ...
  rules: [
...

    {
      ...
      layer: "c-mode",
      mappings: [
        { from: "w", to: zed("~/repos/microsoft/vscode") },
        { from: "e", to: zed("~/repos/Effect-TS/effect") },
        { from: "o", to: zed("~/repos/badlogic/pi-mono") },
        { from: "a", to: zed("~/repos/reatom/reatom") },
        { from: "s", to: zed("~/repos/tarantool/tarantool") },
        { from: "d", to: zed("~/repos/midday-ai/midday") },
        { from: "j", to: zed("~/code/lang/ts") },
        { from: "k", to: zed("~/code/lang/swift") },
        { from: "l", to: zed("~/code/lang/py") },
        { from: "semicolon", to: zed("~/code/lang/go") },
        { from: "grave_accent_and_tilde", to: zed("~/code/lang/zig") },
        { from: "z", to: zed("~/repos/TanStack/ai") },
        { from: "n", to: zed("~/repos/encoredev/encore") },
        { from: "m", to: zed("~/code/lang/mbt") },
    ...
    // v-mode: search
    {
      ...
      layer: "v-mode",
      mappings: [
        { from: "q", to: zed("~/repos/raycast/extensions") },
        { from: "w", to: zed("~/repos/garden-co/jazz2") },
        ...
        { from: "d", to: zed("~/code/org/linsa/linsa") },
...

    {
      ...
      mappings: [
        ...
        { from: "spacebar", to: zed("~/code/lang/ts/test.md") },
    ...
    // m-mode: zed workspaces
    {
      ...
      mappings: [
        ...
        { from: "d", to: zed("~/repos/fuma-nama/fumadocs") },
    ...
    // dot-mode: zed workspaces
    {
      ...
      mappings: [
        ...
        { from: "h", to: zed("~/repos/ClickHouse/ClickHouse") },
