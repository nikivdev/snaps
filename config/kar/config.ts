  ...
  rules: [
...

    {
      ...
      mappings: [
        ...
        { from: "s", to: km("warp: py") },
        { from: "d", to: km("warp: lin-ios") },
        { from: "j", to: km("warp: nikiv") },
    ...
    // v-mode: search
    {
      ...
      mappings: [
        ...
        { from: "e", to: zed("~/code/zerg") },
        { from: "r", to: zed("~/code/telegram") },
        ...
        { from: "s", to: zed("~/code/friendik") },
        { from: "d", to: zed("~/code/org/gen/new") },
        { from: "f", to: zed("~/code/org/1f/sdk") },
        ...
        { from: "z", to: zed("~/code/infra") },
        { from: "n", to: km("warp: lin") },
        { from: "m", to: zed("~/repos/garden-co/jazz2") },
    ...
    // m-mode: zed workspaces
    {
      ...
      mappings: [
        ...
        { from: "s", to: zed("~/repos/reatom/reatom") },
