...
export default {
  ...
  rules: [
...

    {
      ...
      layer: "c-mode",
      mappings: [
        { from: "k", to: zed("~/repos/reatom/reatom") },
        { from: "l", to: zed("~/repos/badlogic/pi-mono") },
        { from: "semicolon", to: zed("~/repos/TanStack/ai") },
      ],
    ...
    // v-mode: search
    {
      ...
      mappings: [
        ...
        { from: "i", to: zed("~/repos/clawdbot/clawdbot") },
        { from: "o", to: zed("~/code/org/gitedit/gitedit") },
        { from: "escape", to: zed("~/code/infra") },
    ...
    // m-mode: zed workspaces
    {
      ...
      mappings: [
        ...
        { from: "v", to: zed("~/repos/clawdbot/clawdbot") },
    ...
    // dot-mode: zed workspaces
    {
      ...
      layer: "dot-mode",
      mappings: [
        { from: "q", to: zed("~/repos/garden-co/jazz") },
        { from: "w", to: zed("~/repos/Effect-TS/effect") },
        { from: "e", to: zed("~/repos/encoredev/encore") },
        { from: "r", to: zed("~/repos/electron/electron") },
        { from: "t", to: zed("~/repos/tarantool/tarantool") },
