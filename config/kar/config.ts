...
import { km, raycast, alfred, shell, zed, linWidget } from "./types/index.ts"
  ...
  rules: [
    ...
    // o-mode: things
    {
      ...
      mappings: [
        ...
        { from: "a", to: km("arc: console.neon.tech") },
    ...
    // dot-mode: zed workspaces
    {
      ...
      layer: "dot-mode",
      mappings: [
        { from: "q", to: zed("~/repos/midday-ai/midday") },
        ...
        { from: "d", to: zed("~/repos/pytorch/pytorch") },
        ...
        { from: "v", to: zed("~/repos/livestorejs/livestore") },
    ...
    // spacebar-mode: screenshots & apps
    {
      ...
      mappings: [
        ...
        { from: "semicolon", to: km("open: Bike") },
        {
          from: "grave_accent_and_tilde",
