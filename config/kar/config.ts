  ...
  rules: [
    ...
    // w-mode: apps
    {
      ...
      mappings: [
        ...
        { from: "semicolon", to: km("open: Electron") },
        ...
        { from: "left_command", to: km("live on/off") },
        { from: "spacebar", to: km("open: Cursor") },
      ],
    },
    ...
    // f-mode: essential
    {
      ...
      mappings: [
        ...
        { from: "s", to: zed("~/config/i/kar/config.ts") },
        { from: "d", to: km("zed: ~/.config/lin/config.ts") },
        { from: "j", to: km("open: Focus") },
        {
          from: "k",
          to: {
            key: "close_bracket",
    ...
    // z-mode: communication
    {
      ...
      mappings: [
        ...
        { from: "k", to: km("arc: localhost:gitedit") },
        ...
        { from: "period", to: km("arc: localhost:nikiv") },
    ...
    // c-mode: warp terminals
    {
      ...
      layer: "c-mode",
      mappings: [
        { from: "0", to: km("warp: config-files") },
    ...
    // v-mode: zed workspaces
    {
      ...
      mappings: [
        ...
        { from: "k", to: km("zed: gitedit") },
        { from: "l", to: km("zed: linsa") },
        { from: "semicolon", to: km("zed: gen") },
    ...
    // b-mode: editing
    {
      ...
      layer: "b-mode",
      mappings: [
        { from: "o", to: km("zed: ~/config/fish/fn.fish") },
    ...
    // m-mode: zed workspaces
    {
      ...
      layer: "m-mode",
      mappings: [
        { from: "tab", to: km("zed: elysia") },
        { from: "q", to: km("zed: verifiers") },
        { from: "w", to: km("zed: reatom") },
        { from: "e", to: km("zed: codex") },
        { from: "t", to: km("zed: tuist") },
        { from: "escape", to: km("zed: llama.cpp") },
        { from: "s", to: km("zed: electron") },
        { from: "d", to: km("zed: mlx") },
        { from: "l", to: km("zed: ell") },
        { from: "semicolon", to: km("zed: jax-js") },
        { from: "grave_accent_and_tilde", to: km("zed: opentinker") },
        { from: "z", to: km("zed: agno") },
        { from: "x", to: km("zed: flox") },
        { from: "c", to: km("zed: electric") },
        { from: "v", to: km("zed: encore") },
        { from: "b", to: km("zed: obs") },
        { from: "left_command", to: km("zed: electron") },
        { from: "spacebar", to: km("zed: zed") },
      ],
    },
    ...
    // dot-mode: zed workspaces
    {
      ...
      layer: "dot-mode",
      mappings: [
        { from: "w", to: km("zed: jazz") },
        { from: "e", to: km("zed: alchemy") },
        { from: "a", to: km("warp: raycast") },
        { from: "s", to: km("zed: kar") },
        { from: "d", to: km("zed: drizzle") },
        { from: "f", to: km("warp: la") },
        { from: "j", to: km("zed: clawdis") },
        { from: "left_command", to: km("zed: rig") },
        { from: "spacebar", to: km("zed: kode") },
      ],
    },
    ...
    // spacebar-mode: screenshots & apps
    {
      ...
      mappings: [
        ...
        { from: "quote", to: km("open: Discord (in Arc)") },
        {
          from: "grave_accent_and_tilde",
          to: km("arc: news.ycombinator/new-comments"),
        },
        { from: "z", to: km("open: Safari Technology Preview") },
        { from: "x", to: km("open: Reader") },
