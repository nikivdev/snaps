...
import { km, raycast, alfred, shell, zed } from "./types/index.ts"
  ...
  rules: [
    ...
    // s-mode: essential navigation and editing
    {
      ...
      mappings: [
        ...
        { from: "spacebar", to: km("paste last flow cmd") },
      ],
    },
    ...
    // tab-mode: sites
    {
      ...
      mappings: [
        ...
        { from: "r", to: km("arc: cloud.cerebras.ai") },
        ...
        { from: "m", to: km("arc: maps.google.com") },
    ...
    // w-mode: apps
    {
      ...
      mappings: [
        ...
        { from: "left_command", to: km("live on/off") }, // todo: breaks
    ...
    // o-mode: things
    {
      ...
      mappings: [
        ...
        { from: "t", to: km("arc: yandex.cloud") },
        { from: "i", to: km("arc: console.neon.tech") },
        { from: "a", to: km("arc: expo") },
        { from: "s", to: km("arc: stripe.com") },
        { from: "d", to: km("arc: aws.amazon.com") },
        ...
        { from: "left_command", to: km("arc: hetzner.com") },
    ...
    // escape-mode: sites
    {
      ...
      mappings: [
        ...
        { from: "n", to: km("arc: fal.ai") },
        { from: "m", to: km("arc: sentry.com") },
        { from: "period", to: km("zed: ~/config/wip.md") },
        { from: "spacebar", to: km("arc: huggingface.com") },
      ],
    },
    ...
    // z-mode: communication
    {
      ...
      mappings: [
        ...
        { from: "spacebar", to: km("open: Simulator") },
      ],
    },
    ...
    // c-mode: warp terminals
    {
      description: "ckey (focus)",
      layer: "c-mode",
      mappings: [
        { from: "tab", to: km("warp: cpp") },
        { from: "q", to: km("warp: train") },
        { from: "w", to: km("warp: flow") },
        { from: "e", to: km("warp: ts") },
        { from: "r", to: km("warp: try") },
        { from: "u", to: km("warp: elixir") },
        { from: "i", to: km("warp: glide") },
        { from: "o", to: km("warp: infra") },
        { from: "p", to: km("warp: riplay") },
        { from: "a", to: km("warp: rust") },
        { from: "s", to: km("warp: swift") },
        { from: "d", to: km("warp: go") },
        { from: "f", to: km("warp: 1f-vscode") },
        { from: "j", to: km("warp: lin") },
        { from: "k", to: km("warp: nikiv") },
        ...
        { from: "z", to: km("warp: py") },
        { from: "n", to: km("warp: lin-ios") },
        { from: "m", to: km("warp: new") },
        { from: "comma", to: km("warp: ai") },
        { from: "period", to: km("warp: gitedit") },
        { from: "slash", to: km("warp: config") },
        { from: "spacebar", to: km("warp: x") },
        { from: "right_command", to: km("warp: mojo") },
      ],
    },

    // v-mode: zed workspaces
    {
      description: "vkey ()",
      layer: "v-mode",
      mappings: [
    ...
    // n-mode: reflect pages
    {
      ...
      mappings: [
        ...
        { from: "h", to: km("reflect: Photos") },
        { from: "k", to: km("reflect: Music") },
        { from: "l", to: km("reflect: Love") },
    ...
    // m-mode: zed workspaces
    {
      ...
      mappings: [
        ...
        { from: "escape", to: km("zed: elysia") },
        { from: "a", to: km("zed: flox") },
        { from: "s", to: km("zed: electron") },
        { from: "d", to: km("zed: mlx") },
        { from: "f", to: km("zed: jax-js") },
    ...
    // spacebar-mode: screenshots & apps
    {
      ...
      mappings: [
        ...
        { from: "k", to: km("open: Glide") },
        { from: "l", to: km("open: Telegram") },
        { from: "semicolon", to: km("open: X Messages (in Arc)") },
        {
          from: "grave_accent_and_tilde",
          to: km("arc: news.ycombinator/new-comments"),
        },
        { from: "z", to: km("open: Reader") },
        { from: "v", to: km("open: IG Messages (in Arc)") },
        { from: "b", to: km("telegram: saved") },
        { from: "n", to: km("telegram: nikivdev") },
        { from: "m", to: km("arc: colab.research.google.com") },
